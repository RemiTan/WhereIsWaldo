# DEFINITION OF THE SCALE : FUNCTIONS gardeAVous() AND allerADistance()

import time
s_time=1000

def gardeAVous(Arm): #makes the Arm stand right
...
def allerADistance(Arm, i, angle) : #makes the Arm go to 
    if i == 0 :
        #position Extreme = E
        gardeAVous(Arm)
        time.sleep(1)
